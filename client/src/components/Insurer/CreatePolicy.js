...
const CONTRACT_ADDRESS = "0x7ed91991A862Cf52E60e2cc213A6c8d80c52Ad81";
      ...
      {showForm && (
        <div style={S.formCard}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={S.group}>
              <label style={S.label}>
                IPFS CID <span style={{ color: "#94A3B8", fontWeight: "normal" }}>(optional)</span>
              </label>
                  ...
                  <tr key={i} style={{ backgroundColor: i % 2 === 0 ? "#fff" : "#f9fafb" }}>
                    ...
                    <td style={S.td}>
                      <span style={{
                        ...
                        color: p.status === "Active" ? "#14532D" : "#7F1D1D",
                      }}>
                        {p.status}
                      </span>
                    </td>
...
const S = {
  ...
  refreshBtn: { backgroundColor: "#F1F5F9", border: "1px solid #bdc3c7", padding: "8px 14px", borderRadius: "8px", cursor: "pointer", fontSize: "13px" },
